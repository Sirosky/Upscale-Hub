...
- **[Download]([url](https://github.com/Sirosky/Sirosky-Upscaling-Models/releases))**
- **Image Comparisons**:
    - Blur Comparison
    - General Comparison
- **Detail Retention**: ⭐⭐⭐⭐⭐
...
- **[Download]([url](https://github.com/Sirosky/Sirosky-Upscaling-Models/blob/main/2x_AniScaleV1_55000.pth))**
- **Image Comparison**
- **Detail Retention**: ⭐⭐⭐⭐
- **Compression Cleanup**: ⭐⭐⭐⭐
